...
    // Arrange
    ...
    var employeeLastName = "TestUser";
    var employeeFullName = $"{employeeFirstName} {employeeMiddleName} {employeeLastName}";
    ...
    await pimAddEmployeePage.ToggleLoginDetailsAsync(true);
    await pimAddEmployeePage.inser
